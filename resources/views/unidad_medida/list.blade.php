            ...
            <div class="card-body">
                <table class="table table-hover table-sm table-bordered " id="tblunidad_medida">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $uni->descripcion_unidad_medida }}</td>
                            <td><a href="{{URL::action('Unidad_MedidaController@edit',$uni->id_unidad_medida)}}"><button
                            class="btn btn-primary btn-sm"  data-toggle="tooltip" title="Editar"><i class="fas fa-edit fa-lg"></i></button>
                                <a href="#" data-target="#modal-delete-{{$uni->id_unidad_medida}}" data-toggle="modal">
