        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="POST"
                    action="<?php echo e(route('cargos.update', $cargos->id_cargo)); ?>">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="descripcion" class="form-control"
                                            ...
                                            value="<?php echo e($cargos->descripcion); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyectoingenielectricasoft\resources\views/cargos/edit.blade.php ENDPATH**/ ?>