...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div align="center" class="card-header"><?php echo e(__('Iniciar Sesión')); ?></div>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="Contraseña"  name="password" required autocomplete="current-password">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyectoingenielectricasoft\resources\views/auth/login.blade.php ENDPATH**/ ?>