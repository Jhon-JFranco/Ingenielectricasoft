    ...
    <div class="app-main__inner col">
        <div class="app-page-title">
            <div class="page-title-wrapper ">
                ...
                <a href="proveedores/create"> <button type="button" data-toggle="tooltip" title="Registrar" data-placement="bottom"
            ...
            <div class="card-body">
                <table class="table table-hover table-sm table-bordered" id="tblprovedores">
                    ...
                    <tbody>
                        ...
                        <td><?php echo e($pro->estado); ?></td>
                        <td><a href="<?php echo e(URL::action('ProveedoresController@edit',$pro->id_proveedor)); ?>"><button
                        class="btn btn-primary btn-sm"  data-toggle="tooltip" title="Editar"><i class="fas fa-edit fa-lg"></i></button>
                            <a href="#" data-target="#modal-delete-<?php echo e($pro->id_proveedor); ?>" data-toggle="modal"><button
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyectoingenielectricasoft\resources\views/proveedores/list.blade.php ENDPATH**/ ?>