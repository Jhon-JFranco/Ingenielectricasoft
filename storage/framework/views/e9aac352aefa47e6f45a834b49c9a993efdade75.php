...
<body>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="layouts.admin" class="mm-active">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('empleados')); ?>>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('usuarios')); ?>>
                                            <i class="metismenu-icon"></i>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('proveedores')); ?>>
                                            <i class="metismenu-icon"></i>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('implementos')); ?>>
                                            <i class="metismenu-icon"></i>
                                            Administrar Implemento
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('pedidos')); ?>>
                                            <i class="metismenu-icon"></i>
                                            Administrar Pedido
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('unidad_medida')); ?>>
                                            <i class="metismenu-icon"></i>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('cargos')); ?>>
                                            <i class="metismenu-icon"></i>
                                            Administrar Cargos
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=<?php echo e(asset('rolles')); ?>>
                                            <i class="metismenu-icon"></i>
                                            Administrar Rol
                                        </a>
                                    </li>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/main.js')); ?>""></script></body>

</body>

</html>
<?php /**PATH C:\laragon\www\proyectoingenielectricasoft\resources\views/home.blade.php ENDPATH**/ ?>