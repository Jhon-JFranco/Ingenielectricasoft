        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="POST"
                    action="<?php echo e(route('unidad_medida.update', $unidad_medida->id_unidad_medida)); ?>">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="descripcion" class="form-control"
                                            ...
                                            value="<?php echo e($unidad_medida->descripcion); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyectoingenielectricasoft\resources\views/unidad_medida/edit.blade.php ENDPATH**/ ?>