    ...
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="POST" action="<?php echo e(route('proveedores.store')); ?>">
                 <?php echo csrf_field(); ?>
                  <div class="box">
                        <div class="box-body">
                            <div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proyectoingenielectricasoft\resources\views/proveedores/create.blade.php ENDPATH**/ ?>